...
var columns=[
    ...
    },
    {
        ...
        formatter:function (row,value,index) {
            var btnInstockInner=$('<button class="btn btn-info"></button>').html('<i class="fa fa-th-list" aria-hidden="true"></i>领用')
...
var columns1=[
    ...
    },
    {
        title:'转移',
        formatter:function (row,value,index) {
            var btnInstockInner=$('<button class="btn btn-info"></button>').html('<i class="fa fa-th-list" aria-hidden="true"></i>转移')
