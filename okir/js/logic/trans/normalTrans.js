...
var columns =
    [
        ...
        formatter:function (row,value,index) {
            var btnTransInner=$('<button class="btn btn-info"></button>').html('<i class="fa fa-th-list" aria-hidden="true"></i> 转移')
...
var column = [
        ...
        title: '领用操作',
        formatter:function (row,value,index) {
            var btnTransInner=$('<button class="btn btn-info"></button>').html('<i class="fa fa-th-list" aria-hidden="true"></i> 领用')
